...
const getArrayComments = () => {
  return new Array(getRandomNumber(Comments.MIN, Comments.MAX)).fill(null).map(() => getComment(idComments));
};
...
const getDescribing = () => {
  return {
    id: getElement(idDescriptions),
    url : 'photos/' + addresses.pop() + '.jpg',
